 ...
 * 自定义view 设置给行布局上头像
 */
public class CirlcleImageView extends ImageView {
    public CirlcleImageView(Context context) {
        super(context);
    }

    public CirlcleImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CirlcleImageView(Context context, AttributeSet attrs, int defStyleAttr) {
