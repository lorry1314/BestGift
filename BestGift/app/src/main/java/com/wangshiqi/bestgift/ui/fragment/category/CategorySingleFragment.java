...
import com.wangshiqi.bestgift.ui.adapter.SingleLeftLvAdapter;
import com.wangshiqi.bestgift.ui.adapter.SingleRightLvAdapter;
    ...
    protected void initDatas() {
        ...
        VolleyInstance.getInstance().startRequest(NetUrl.SINGLE, new IVolleyResult() {
            ...
            public void success(String resultStr) {
                ...
                List<SingleBean.DataBean.CategoriesBean> datas = bean.getData().getCategories();
